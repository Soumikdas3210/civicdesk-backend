...
const TEMPLATE_MAP: Partial<
  Record<NotificationType, { template: string; subjectPrefix: string }>
> = {
  [NotificationType.GRIEVANCE_SUBMITTED]: {
    template: 'grievance-received',
    subjectPrefix: 'Grievance Received',
  },
  [NotificationType.GRIEVANCE_ASSIGNED]: {
    template: 'grievance-assigned',
    subjectPrefix: 'New Grievance Assigned',
  },
  [NotificationType.GRIEVANCE_RESOLVED]: {
    template: 'grievance-resolved',
    subjectPrefix: 'Grievance Resolved',
  },
